...
import { Utilities, DBkeys, JwtHelper } from '../util/index.utils';
...
export class AuthService {
  ...
  constructor(private router: Router, private configurations: ConfigurationService, private endpointFactory: EndpointFactoryService, private localStorage: LocalStoreManager) {
  ...
  login(loginView: LoginView) {
    ...
    return this.endpointFactory.getLoginEndpoint<LoginResponse>(loginView)
      .pipe(map(response => this.processLoginResponse(response, loginView.RemberMe)));
  }
